  ...
  public: {
    Tables: {
      ...
      budget_limits: {
        ...
        Relationships: [
          {
            foreignKeyName: "budget_limits_budget_owner_fk";
      ...
      savings_goal_contributions: {
        ...
        Relationships: [
          {
            foreignKeyName: "savings_goal_contributions_goal_owner_fk";
      ...
      subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "subscriptions_account_owner_fk";
    ...
    Functions: {
      ...
      recalculate_goal_current_amount: {
    ...
    Enums: {
      ...
      transaction_source: "manual" | "salary";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
